...
def get_jobs_list(
    ...
    job_filter: Annotated[str, Field(description="The job types to filter by. Multiple types can be provided, comma-separated. If not used, returns backup jobs. Common values: Backup, Restore, AUXCOPY, SNAPBACKUP, SNAPSHOT, DATA_VERIFICATION, WORKFLOW, SEND_LOGFILE, DDBOPS, INFOMGMT, REPLICATION, SYNTHFULL, VM_Management, UPGRADE_CLIENT, TAPEIMPORT. Any valid Commvault job type name is accepted, not just these.")]="",
